...
int main(int argc, char** argv)
{
	if(argc < 3 )
	{
		...
		cout << "  Usage: envmaker [fisheye image] [diameter] [focal length] [center x] [center y] [size x] [size y] [latlong image]\n\n";
		...
		cout << "  [center y]         \n";
		cout << "  [size x]           Size of the latlong to be created\n";
		cout << "  [size y]           \n";
	...
	for(int i=0 ; i<latlong_h; i++)
	{
		for(int j=0; j<latlong_w; j++)
		{
			...
			//Other lenses must be added later and selected as option
